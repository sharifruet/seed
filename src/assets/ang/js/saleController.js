...
define(['myApp'], function (app) {
	 ...
	 var saleController = function ($scope, configurationService, saleService) {
...
app.register.controller('menuController', ['$scope','configurationService','salesService', saleController]);
