...
class MY_Controller extends CI_Controller
{
    ...
    protected function getBalance($accountId = -1, $cat1 = '-1', $cat2 = '-1', $cat3 = '-1', $dateFrom = '2000-01-01', $dateTo = "-1")
    {
        if ($dateTo == "-1")
            $dateTo = date("Y-m-d");
        
        $sql = "SELECT FORMAT(IFNULL(SUM(d.type*quantity*unitPrice*(CASE WHEN a.category1='" . Applicationconst::ACCOUNT_CAT1_LIABILITY . "' OR a.category1='" . Applicationconst::ACCOUNT_CAT1_REVENUE . "' THEN -1 ELSE 1 END) ),0),2) AS balance
